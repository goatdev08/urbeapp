-- Rollback: 20260908100001_crm_agency_overview_removed.sql (tarea #278)
-- Restaura public.crm_agency_overview EXACTAMENTE como la dejó 20260906400001 (kind='unmanaged'
-- solo por agency_members.status='suspended', join directo). Aditiva pura: nada más que
-- restaurar. Round-trip: supabase/tests/107 vuelve a su plan anterior en rojo (REMOVED1) y el
-- resto del contrato intacto.
--
-- ════════════════════════════════════════════════════════════════════════════
