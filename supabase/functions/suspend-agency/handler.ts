...
// STUB de la fase RED (subtarea #211.1). Sin lógica de negocio: devuelve
// siempre 501 para que cada caso de handler.test.ts falle por ASERCIÓN de
// status/body, nunca por un import roto.

import type { SuspendAgencyDeps } from "./types.ts";

export function handler(_req: Request, _deps: SuspendAgencyDeps): Promise<Response> {
