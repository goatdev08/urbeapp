...
/** Las dos únicas decisiones que un admin toma sobre un anuncio pendiente. */
export type ModerateAdAction = "approve" | "reject";
...
export type AdModerationResult =
  | { ok: true; status: "active" | "rejected" }
