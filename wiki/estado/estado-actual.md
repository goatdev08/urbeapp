...
- **Sistema de trabajo:** vault Obsidian densificado ([[0003-vault-obsidian-como-memoria]]); **Taskmaster** con backlog de **20 tareas** (7 done, 13 pending), provider `claude-code/sonnet` ([[0004-taskmaster-motor-de-ejecucion]]).
