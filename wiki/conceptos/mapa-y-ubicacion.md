...
- ⏳ **Pendiente (Fase C #42):** feed/mapa por distancia (consumen el RPC + `useLocation().coords`; paginación rediseñada por distancia) + centrado del mapa en ubicación real + radio en `FilterSheet` (default 5km, expansión progresiva ante 0 resultados). Ver exploración `027-ubicacion-obligatoria-feed-mapa-cercania.md`.
