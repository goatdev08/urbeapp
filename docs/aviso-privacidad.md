...
| §5 "se conserva un máximo de 90 días" | ⏳ **por construir (170.5)**: `purge_ad_impressions()` **programada con `pg_cron`** — decisión de Abraham 2026-08-17, revisada: su primera respuesta fue dejar la función sin programador, y la cambió al ver que el aviso pasaba a prometer el plazo por escrito. Una retención que nadie ejecuta es una defensa afirmada que no existe, en un documento legal | ⏳ pgTAP de 170.5: la purga borra >90d, respeta <90d, y el job existe en `cron.job` |
