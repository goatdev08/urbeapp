...
export function FeedScreen() {
  ...
  // #288.3 — la vuelta ya no se señala: el chip «Ya viste todo · volvemos a
  // empezar» de 285.5 se retiró (Abraham, 2026-09-10: el cambio debe ser
  // imperceptible). La costura se cierra con carga adelantada (threshold) y
  // sin video repetido pegado (288.2), no con aviso.
      ...
      {!is_skeleton && !is_error && !is_empty && (
        <>
          ...
          <FlashList
            ...
            // Scroll infinito: dispara a 2 alturas visibles del final — con
            // paginación por pantalla, 2 swipes antes. #288.3: la página o la
            // vuelta (RPC + mint-video-url + anuncios ≈ 1–1.5 s) llega antes de
            // que la persona alcance el último ítem, sin chip ni espera.
            // ponytail: precarga por umbral, no precarga ansiosa al recibir la
            // última página (esa compone anuncios que nadie ve y consume el tope
            // por sesión en cada apertura) — techo conocido: red lenta + swipe
            // muy rápido acaban la lista con rebote; si se ve, derivada polish(288).
            // loadMore ya guarda internamente contra la reentrada.
