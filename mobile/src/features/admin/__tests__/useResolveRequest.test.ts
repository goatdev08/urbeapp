 ...
 *
 * RPCs pinneadas (221.2/221.1, otra rama):
 *   resolve_agent_application({p_application_id, p_approve, p_reason?})
 *   resolve_advertising_request({p_request_id, p_approve, p_reason?})
 * Errores P0001 con código embebido en error.message: REQUEST_NOT_FOUND |
 * ALREADY_RESOLVED | REASON_REQUIRED.
 *
 ...
 *
 * EDGE CASES (por cada uno de los 2 hooks — EC-N se repite en 2 describes):
